...
type PetHandler interface {
	...
	GetWithUser(w http.ResponseWriter, r *http.Request)
...
func (h *petHandler) GetWithUser(w http.ResponseWriter, r *http.Request) {
	id := r.FormValue("id")
	idInt, _ := strconv.Atoi(id)
	pet, _ := h.petService.FindWithUser(idInt)
